...
--
-- Host: localhost
-- Generation Time: Aug 30, 2016 at 10:43 PM
...
(30, 75, '2016-08-09 01:16:43', 200, 'Login realizado com sucesso', '/proj01-thiago/manager/loga_cliente/check_credentials', '10.0.2.2'),
(31, 75, '2016-08-09 01:16:49', 600, 'Logout realizado', '/proj01-thiago/manager/Loga_cliente/Logout', '10.0.2.2'),
(32, 75, '2016-08-30 06:15:58', 200, 'Login realizado com sucesso', '/proj01-thiago/manager/loga_cliente/check_credentials', '10.0.2.2'),
(33, 75, '2016-08-30 06:26:06', 600, 'Logout realizado', '/proj01-thiago/manager/Loga_cliente/Logout', '10.0.2.2'),
(34, 0, '2016-08-30 06:30:56', 404, 'Falha no login', '/proj01-thiago/manager/loga_cliente/check_credentials', '10.0.2.2'),
(35, 0, '2016-08-30 06:31:05', 404, 'Falha no login', '/proj01-thiago/manager/loga_cliente/check_credentials', '10.0.2.2'),
(36, 0, '2016-08-30 06:33:43', 404, 'Falha no login', '/proj01-thiago/manager/loga_cliente/check_credentials', '10.0.2.2'),
(37, 0, '2016-08-30 06:53:58', 404, 'Falha no login', '/proj01-thiago/manager/loga_cliente/check_credentials', '10.0.2.2'),
(38, 0, '2016-08-30 06:54:26', 404, 'Falha no login', '/proj01-thiago/manager/loga_cliente/check_credentials', '10.0.2.2'),
(39, 0, '2016-08-30 06:54:51', 404, 'Falha no login', '/proj01-thiago/manager/loga_cliente/check_credentials', '10.0.2.2'),
(40, 0, '2016-08-30 06:55:19', 404, 'Falha no login', '/proj01-thiago/manager/loga_cliente/check_credentials', '10.0.2.2'),
(41, 0, '2016-08-30 06:56:01', 404, 'Falha no login', '/proj01-thiago/manager/loga_cliente/check_credentials', '10.0.2.2'),
(42, 0, '2016-08-30 07:01:48', 404, 'Falha no login', '/proj01-thiago/manager/loga_cliente/check_credentials', '10.0.2.2'),
(43, 75, '2016-08-30 07:41:20', 200, 'Login realizado com sucesso', '/proj01-thiago/manager/loga_cliente/check_credentials', '10.0.2.2'),
(44, 75, '2016-08-30 07:43:41', 600, 'Logout realizado', '/proj01-thiago/manager/Loga_cliente/Logout', '10.0.2.2');
...
) ENGINE=InnoDB AUTO_INCREMENT=119349798504554 DEFAULT CHARSET=utf8;
...
(75, 'Ricardo Costa', '0', '', '(55) 5555-5555', '(55) 5 5555-5555', 'S', '(55) 5555-5555', '255', 'ricacom@gmail.com', '$2a$10$bbb69e3f9ac1e82215080OkRtfYR4yme6rA0.uOkNw4GoNOo/hvk6', 'N', '2015-05-23 05:31:29', NULL, '2015-05-23 05:05:52', '', '', 0, 'form_site'),
...
--
-- Indexes for table `cliente_controle`
--
ALTER TABLE `cliente_controle`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `convenio_medico`
--
ALTER TABLE `convenio_medico`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `establishment`
  ...
  ADD KEY `fk_estabelecimento_grupo1_idx` (`grupo_id`);

--
-- Indexes for table `establishment2convenio_medico`
--
ALTER TABLE `establishment2convenio_medico`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_establishment2convenio_medico_establishment1_idx` (`establishment_id`),
  ADD KEY `fk_establishment2convenio_medico_convenio_medico1_idx` (`convenio_medico_id`);
...
ALTER TABLE `user2group`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `id_UNIQUE` (`id`),
  ADD KEY `fk_user2group_users1_idx` (`users_id`),
  ADD KEY `fk_user2group_grupo1_idx` (`grupo_id`);
...
ALTER TABLE `user_control`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_cliente_controle_users1_idx` (`users_id`);
...
--
-- AUTO_INCREMENT for table `cliente_controle`
--
ALTER TABLE `cliente_controle`
  MODIFY `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `convenio_medico`
--
ALTER TABLE `convenio_medico`
...
--
-- AUTO_INCREMENT for table `establishment2convenio_medico`
--
ALTER TABLE `establishment2convenio_medico`
  MODIFY `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `log`
  MODIFY `lg_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=45;
--
...
--
ALTER TABLE `users`
  MODIFY `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=119349798504554;
--
