...
class DashboardAdmin extends CI_Controller {
	...
	public function index()	{
		...
		$this->load->view('commons/headerAdmin', $data);
		$this->load->view('commons/side_bar');
		$this->load->view('dashboardAdmin_v', $dtRecords);
		$this->load->view('commons/footerAdmin',$dtfooter);
