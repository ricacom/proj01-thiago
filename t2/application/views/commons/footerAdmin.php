...
<script type="text/javascript" src="<?php echo base_url().'assets/plugins/sb-admin/metisMenu.min.js' ?>"></script> 
<script type="text/javascript" src="<?php echo base_url().'assets/plugins/sb-admin/raphael-min.js' ?>"></script> 
 
<script type="text/javascript" src="<?php echo base_url().'assets/plugins/sb-admin/sb-admin-2.js' ?>"></script> 
...
<script type="text/javascript" src="<?php echo base_url().'assets/plugins/smoothScroll.js' ?>"></script>
 ...
 <script type="text/javascript" src="<?php echo base_url().'assets/plugins/sb-admin/morris.min.js' ?>"></script> 
<script type="text/javascript" src="<?php echo base_url().'assets/plugins/sb-admin/morris-data.js' ?>"></script> 
